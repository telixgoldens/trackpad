...
export const THEME_CLASSES = {
  light: {
    ...
    shadow: "shadow-lg",
    pnlPositive: "text-green-600 bg-green-50",
    pnlNegative: "text-red-600 bg-red-50",
  },
  dark: {
    ...
    accentBg: "bg-yellow-500 hover:bg-yellow-600",
    accentText: "text-yellow-400",
    border: "border-gray-700",
    shadow: "shadow-2xl shadow-gray-950/50",
    pnlPositive: "text-green-400 bg-green-900",
    pnlNegative: "text-red-400 bg-red-900",
  },
};
