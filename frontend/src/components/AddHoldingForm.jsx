...
const AddHoldingForm = ({ onAdd }) => {
  ...
  return (
    <form
      ...
      className="grid grid-cols-2 lg:grid-cols-6 gap-4 pt-4 border-t border-dashed"
    >
      <div>
      ...
      <div className="col-span-2 lg:col-span-6 flex justify-end">
        <button
          type="submit"
          className={`px-6 py-3 rounded-lg font-bold transition duration-300 shadow-md ${theme.accentBg} text-white`}
        >
          Add Holding
        </button>
      </div>
