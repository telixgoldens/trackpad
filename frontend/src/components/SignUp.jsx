        ...
        <div className="col-md-5">
          <div className="glass-card">
            ...
            <p className="text-center text-secondary small mb-4">
              Initialize your digital asset identity
            </p>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="mb-3">
                ...
                />
                {errors.password && (
                  <div className="error-text">MIN 8 CHARACTERS</div>
                )}
              </div>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  {...register("verify", {
                    required: "Required",
                    validate: (v) => v === password || "Keys mismatch",
                  })}
                />
                {errors.verify && (
                  <div className="error-text">{errors.verify.message}</div>
                )}
              </div>
